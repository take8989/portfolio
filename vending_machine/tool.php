...
<body>
    ...
    <section>
        ...
        <table>
            ...
            <?php
            foreach ($drink_data as $value) { ?><tr <?php if ($value['public_status'] === '0') {print 'class = "status_false"';}?>>
                <form method="POST">
                ...
                <form method="post">
                    <td>
                        ...
                        if($value['public_status'] === '0') { print "非公開&nbsp→&nbsp公開";}
                        else if ($value['public_status'] === '1') { print "公開&nbsp→&nbsp非公開";}
                        ?>>
